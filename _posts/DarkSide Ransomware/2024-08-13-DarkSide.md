...
### Extracting and Decrypting Malware Configuration

Malware will store his encrypted configuration in a local variable then he will put the data in allocated heap ready to decrypt it.

![alt text](figure115.png)

And we can see the code responsible of that from here.

![alt text](figure116.png)

After resolving the APIs, malware will get in the next function at Address `00402C4B` and will start Decrypt the data written in the Allocated heap.

![alt text](figure47.png)

after decrypting the data that is written in the heap I found many directories, files, Extensions and services, Malware listed this data to avoid it during the encryption process.
...
Malware will allocate a space in the memory to put his encrypted data and will decrypt it using his algorithm as we can see it in the next figure in IDA PRO, we will see the name of the his private file named `"README.1a7cfdf5.TXT"` in which he tells us in it that our files have been encrypted and in which he asks us for ransom and how to pay it.
...
|SHA-256| F3F25AF554BEDFA4EE2824BB858280282BD87828D446048619DC49FE061741B4 |
|SHA-1|C30358563FA940EB5CD6064D4D16DEFEE43B0310|
